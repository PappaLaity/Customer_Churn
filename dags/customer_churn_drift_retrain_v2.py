...
"""
DAG de détection de drift SIMPLE et ROBUSTE
- Lit PostgreSQL et compare avec CSV de référence
- Méthodes statistiques standards (KS, PSI, Chi²)
- Génère un rapport HTML interactif SIMPLE
- Pas de dépendances compliquées (evidently/alibi)
"""
from datetime import datetime, timedelta
import os
import json
