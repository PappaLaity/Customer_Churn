...
def generate_drift_report(
    ...
    categorical_features = baseline_df.select_dtypes(
...
def generate_model_performance_report(
    ...
    return {
        "status": "skipped",
        "reason": "performance reports require predictions in dataset",
    }
...
def generate_data_quality_report(
    ...
    try:
        ...
        return {
            "status": "skipped",
            "reason": "data file has no columns or is malformed",
        }
    except Exception as e:
